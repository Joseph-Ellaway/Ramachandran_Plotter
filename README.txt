...
Phenix Suite (install from https://www.phenix-online.org/download/)
...
Adjustable parameters:
	...
	Contour level 			|	contour_level			|	Level at which to draw the contour lines. Should be a value between 0-100 to 
							|							|	represent to percemtile at which dihedral angles from the Top8000 peptide DB fall
							|							|	within. e.g. a value 96 coresponds to the area where 96 % of dihedral angles fall 
							|							|	within. 
